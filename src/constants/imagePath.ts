export default {
  ...
  ic_Tickk:require('../assets/images/ic_Tickk.png'),
  icGreyCheckbox:require('../assets/images/ic_greyCheckbox.png'),
  icBackArrow:require('../assets/images/ic_Backarrow.png'),
  ic_Checkk:require('../assets/images/ic_Checkk.png'),
  icMoneyBank:require('../assets/images/ic_MoneyBank.png'),
  ic_Searchh:require('../assets/images/ic_Searchh.png'),
  icChatt:require('../assets/images/ic_Chatt.png'),
  icChattThemeActive:require('../assets/images/ic_ChattThemeColor.png'),
  icInActiveAccount:require('../assets/images/ic_Account.png'),
  icActiveSearch:require('../assets/images/icActiveSearch.png'),
  icActiveAcount:require('../assets/images/icActiveAccount.png'),
  icQuickSplash:require('../assets/images/icQuickSplash.mp4'),
  icRemote:require('../assets/images/icRemote.png'),
  icMapIcon:require('../assets/images/icMapIcon.png'),
  icBAckground:require('../assets/images/icBackground.png'),
  icNotification:require('../assets/images/icNotification.png'),
  icRemoteTV:require('../assets/images/icRemoteTv.png'),
  icAboutt:require('../assets/images/icAbout.png'),
  icCity:require('../assets/images/icCity.png'),
  icLanguage:require('../assets/images/icLanguage.png'),
  icNotificationn:require('../assets/images/icNotificationn.png'),
  icPrivacyPolicy:require('../assets/images/icPrivacyPolicy.png'),
  icReviews:require('../assets/images/icReviews.png'),
  icTask1:require('../assets/images/icTask1.png'),
  icTermsnCondition:require('../assets/images/icTerms&Condition.png'),
  icCall:require('../assets/images/icCall.png'),
  icLogoutt:require('../assets/images/icLogoutt.png'),
  icForwardArrow:require('../assets/images/icForwardArrow.png'),
  icLockk:require('../assets/images/icLocck.png'),
  icSpotifiy:require('../assets/images/ic_Spotify.jpeg')
